...
class CustomUser(models.Model):
    ...
    avatar = models.ImageField(upload_to='avatars/',  blank = True, default='avatars/img_avatar.png')
...
class Task(models.Model):
    ...
    assign = models.ManyToManyField(User, default=1)
...
class SubTaskComment(models.Model):
    subtask = models.ForeignKey(SubTask,on_delete=models.CASCADE,related_name = 'subtask_comment' )
    name = models.CharField(max_length=100)
    comment  = models.TextField()
